<template>
    <q-layout padding>
                  ...
                  <q-row class="q-pa-md" style="display: flex; height: 100%;">
                    ...
                    <q-col style="width: 15%; height: 100%; display: block;">
                      ...
                      <q-card-actions align="right">
                        <q-btn  style="height: min-content; width:min-content;" color="primary" icon="mdi-pencil-outline" @click="editarElemento(noticia, 'noticia')" />
                        <q-btn style="height: min-content; width:min-content;" color="negative" icon="mdi-delete-empty-outline" @click="eliminarNoticia(noticia.id)" />
                      </q-card-actions>
                    </q-col>
                  </q-row>
                </q-card-section>
            ...
            <div v-if="servidores.length" style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 1rem;">
              <q-card v-for="servidor in servidores" :key="servidor.id" class="q-pa-md" style="height: 25vh;">
                <q-card-section>
                  ...
                  <q-card-actions align="right">
                    <q-btn style="height: min-content; width:min-content;" color="primary" icon="mdi-pencil-outline" @click="editarElemento(servidor, 'servidor')" />
                    <q-btn style="height: min-content; width:min-content;" color="negative" icon="mdi-delete-empty-outline" @click="eliminarServidor(servidor.id)" />
                  </q-card-actions>
                </q-card-section>
      ...
      <!-- Dialogo para editar noticias o servidores -->
